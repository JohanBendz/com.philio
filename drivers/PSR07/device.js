...
class PSR07 extends ZwaveDevice {
	async onNodeInit() {
		// REGISTER FLOWS
		this._triggerOn = this.getDriver().PSR07_onTrigger;
		this._triggerOff = this.getDriver().PSR07_offTrigger;
		this._triggerDim = this.getDriver().PSR07_dimTrigger;
		this._triggerScene = this.getDriver().PSR07_sceneTrigger;
